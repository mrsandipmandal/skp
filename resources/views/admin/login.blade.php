<!doctype html>
<html lang="en" class="layout-wide customizer-hide" data-assets-path="{{ url('/') }}"
...
<head>
    ...
    <title>{{ isset($page_title) ? $page_title : config('app.name') }} : Login</title>
...
<body>
    ...
    <div class="position-relative">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-6 mx-4">
                        ...
                        <a href="#" class="app-brand-link gap-3">
                            <span class="app-brand-logo demo">
                                ...
                                {{-- <svg width="30" height="24" viewBox="0 0 250 196" fill="none"
                                    ...
                                    <img class="img-fluid rounded mb-4" src="{{ config('app.logo_dark') }}" height="120" width="160" alt="logo"/>
                                </span>
                            </span>
                    ...
                    <div class="card-body mt-1">
                        ...
                        <form id="formAuthentication" class="mb-5" action="{{ url('/login') }}" method="post"
                            ...
                            <div class="mb-5 pb-2 d-flex justify-content-between pt-2 align-items-center">
                                ...
                                <a href="{{ url('/') }}" class="float-end mb-1">
                        ...
                        <p class="text-center mb-5" hidden>
                ...
                <img src="{{ url('/') }}/assets/img/illustrations/auth-basic-mask-light.png"
                    class="authentication-image d-none d-lg-block scaleX-n1-rtl" height="172" alt="triangle-bg" />
                <img src="{{ url('/') }}/assets/img/illustrations/tree.png" alt="auth-tree"
    ...
    <!--<div class="buy-now">
        <a href="https://themeselection.com/item/materio-dashboard-pro-bootstrap/" target="_blank"
            class="btn btn-danger btn-buy-now">Help</a>
    </div>-->
    <!-- Core JS -->
    ...
    <script src="{{ url('/') }}/dist/js/jquery-3.6.1.js"></script>
    <script src="{{ url('/') }}/dist/js/sweetalert2.all.min.js"></script>
    @if (session()->has('nol_typ') && session()->has('nol_message'))
    <script>
        Swal.fire({
            position: 'center',
            icon: '{{ session('nol_typ') }}',
            title: '{{ session('nol_message') }}',
